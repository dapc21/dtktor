 ...
 * @author Daniel Peña
 */
Ext.define('eborasvehicle.view.Tools.FilterDashboard', {
    extend: 'Ext.container.Container',
    xtype: 'app-filter-dashboard',
    itemId: 'filterDashboard',
    id: 'filterDashboard',
    cls: 'ctn-filter',
    style: 'margin: 0px 0px 0px 55px;',
    require: ['Ext.Date'],
    initComponent: function() {
        var storePlate = Ext.create('eborasvehicle.store.Dashboard.Plates');
        var storeGroup = Ext.create('eborasvehicle.store.Dashboard.Groups');
        var storeVehicle = Ext.create('eborasvehicle.store.Tools.Vehicles');
        var storePlatePlanner = Ext.create('eborasvehicle.store.Tools.Plates');
        ...
        this.items = [{
            ...
            items: [{
                    ...
                    items: [{
                        ...
                        listeners: {
                            click: function(button) {
                                    ...
                                    var endDate = button.up().up().up().up().down('[name=end_date_dashboard]');
                                    var statDate = button.up().up().up().up().down('[name=start_date_dashboard]');
                                    var VehiclesPlate = button.up().up().up().up().down('[name=license_plate_dashboard]');
                                    var gorup = button.up().up().up().up().down('[name=vehicle_group_dashboard]');
                                                            ...
                                                            afterrender: function(comb) {
                                                                comb.store.load({
                                                                    ...
                                                                    callback: function(records, operation, success) {
                                                                        ...
                                                                        var comboPlaca = comb.up().up().down('[name=license_plate_dashboard]');
                                                                        comboPlaca.store.load({
                                                                            scope: this,
                                                                            callback: function(records, operation, success) {
                                                                                // the operation object
                ...
                },
                {
                    ...
                    items: [{
                        xtype: 'combobox',
                        id: 'license_plate_dashboard',
                        name: 'license_plate_dashboard',
                        hideLabel: true,
                        store: storePlate,
                        displayField: 'plate',
                        valueField: 'plate',
                ...
                },
                {
                    ...
                    items: [{
                        xtype: 'combobox',
                        id: 'vehicle_group_dashboard',
                        name: 'vehicle_group_dashboard',
                        hideLabel: true,
                        store: storeGroup,
                        displayField: 'group',
                        valueField: 'id',
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        {
                            xtype: 'datefield',
                            id: 'end_date_dashboard',
                            name: 'end_date_dashboard',
                            labelAlign: 'left',
                            format: 'Y-m-d',
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        {
                            xtype: 'datefield',
                            id: 'start_date_dashboard',
                            name: 'start_date_dashboard',
                            labelAlign: 'left',
                            ...
                            listeners: {
                                select: function(comb, records) {
                                    comb.setValue(records);
                                    var date = comb.up().up().down('[name=end_date_dashboard]');
